...
<body onLoad="muestraReloj()" class="fix-header">
   ...
   <!-- ============================================================== -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-boxed-layout="full" data-boxed-layout="boxed" data-header-position="fixed" data-sidebar-position="fixed" class="mini-sidebar">             
        ...
        <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Búsqueda Pedidos</h5>
                    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Búsqueda Pedidos</h4>
            </div>
            
        <form class="form form-material" method="post" action="#" name="pedidosxproveedores" id="pedidosxproveedores">
    ...
    <?php } ?> 
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscarPedidosxProveedores()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestrapedidosxproveedores"></div>
