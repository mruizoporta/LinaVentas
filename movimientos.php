    ...
    <div class="modal-dialog modal-lg">
        ...
        <form class="form form-material" method="post" action="#" name="savemovimiento" id="savemovimiento">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input class="form-control" type="text" name="montomovimiento" id="montomovimiento" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" autocomplete="off" placeholder="Ingrese Monto de Movimiento" required="" aria-required="true"> 
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                   <div class="form-group has-feedback">
                        ...
                        <option value="<?php echo $medio[$i]['codmediopago'] ?>"><?php echo $medio[$i]['mediopago']; ?></option> <?php } } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="fecharegistro" id="fecharegistro" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha de Movimiento" autocomplete="off" readonly="" aria-required="true"/> 
            ...
            <div class="modal-footer">
                ...
                document.getElementById('codmediopagobd').value = '',
