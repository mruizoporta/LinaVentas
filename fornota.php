        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control calendario" name="fechanota" id="fechanota" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Fecha de Nota" autocomplete="off" required="" aria-required="true"/> 
                ...
                <div class="form-group has-feedback2"> 
                   ...
                   <i class="fa fa-comment-o form-control-feedback2"></i> 
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscarFactura()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </div>
