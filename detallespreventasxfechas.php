...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="detallespreventasxfechas" id="detallespreventasxfechas">
...
<?php } ?>
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscaDetallesPreventasxFechas()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestradetallespreventasxfechas"></div>
