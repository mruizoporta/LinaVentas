        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(assets/images/login-register.jpg) no-repeat center top;position: absolute; height: 100%; width: 100%; top: 0; left: 2px;">
            <div class="auth-box">
              ...
              <div id="loginform">
                ...
                <div class="logo">
                  <span class="db"><?php if (file_exists("fotos/logo-negro-bloque.png")){
                    echo "<img src='fotos/logo-negro-bloque.png' width='90%' height='80px' alt='Logo Principal'>"; 
                            } else {
                    echo "<img src='' width='90%' height='80px' alt='Logo Principal'>"; 
                            } 
                    ?></span>
                  ...
                  <div class="col-12">
                   ...
                   <form class="form form-material new-lg-form" name="lockscreen" id="lockscreen" action="">
                    ...
                    <div class="form-group text-center m-t-20">
                      <div class="col-xs-12">
                        <button class="btn btn-outline-danger btn-lg btn-block waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Haga clic aquí para iniciar sesión" name="btn-login" id="btn-login" type="submit"><span class="fa fa-sign-in"></span> Acceder</button>
                      </div>
                    </div>
