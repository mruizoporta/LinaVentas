                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control" name="nombres" id="nombres" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Nombres y Apellidos" autocomplete="off" required="" aria-required="true"/>  
...
<?php if ($_SESSION['acceso'] == "administradorG") { ?><option value="ADMINISTRADOR(A) GENERAL">ADMINISTRADOR(A) GENERAL</option><?php } ?>
                ...
                <?php if ($_SESSION['acceso'] == "administradorS") { ?>
                    ...
                    <div class="col-md-3"> 
                        <div class="form-group has-feedback"> 
                            ...
                            <input style="color:#000;font-weight:bold;" type="hidden" name="codsucursal" id="codsucursal" value="<?php echo encrypt($_SESSION['codsucursal']); ?>"><input type="text" class="form-control" name="sucursal" id="sucursal" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Nombre de Sucursal" value="<?php echo $_SESSION["nomsucursal"]; ?>" readonly="readonly">
                    ...
                    <div class="form-group has-feedback">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="form-group has-feedback"> 
                                ...
                                </div><small><p>Para Subir la Foto de Usuario debe tener en cuenta:<br> * La Fotografia debe ser extension.jpg<br> * La imagen no debe ser mayor de 50 KB</p></small>
                                </div>
                            </div>
                    </div> 
                </div>
            ...
            <div class="modal-footer">
                ...
                document.getElementById('codsucursal').value = '0',
