...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="detallespreventasxvendedor" id="detallespreventasxvendedor">
...
<?php } ?>
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscaDetallesPreventasxVendedor()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestradetallespreventasxvendedor"></div>
