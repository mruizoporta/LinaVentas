...
$(document).ready(function() {
    ...
    function AgregaCotizaciones () {
            ...
            var busqueda = $('input#search_busqueda').val();
            ...
            if (code == "" && tipodetalle == 1) {
            ...
            } else if (tipodetalle == 2 && busqueda == "") {
                $("#search_busqueda").focus();
                $("#search_busqueda").css('border-color', '#ff7676');
           ...
           } else if(cantp > exist && tipodetalle == 1){
                $("#cantidad").focus();
                $('#cantidad').css('border-color','#ff7676');
                ...
                Carrito.Id = ($('input:radio[name=tipodetalle]:checked').val() == 1 ? $('input#idproducto').val() : "0");
                Carrito.Codigo = ($('input:radio[name=tipodetalle]:checked').val() == 1 ? $('input#codproducto').val() : "0");
                Carrito.Producto = ($('input:radio[name=tipodetalle]:checked').val() == 1 ? $('input#producto').val() : $('input#search_busqueda').val());
                ...
                Carrito.Precio = ($('input:radio[name=tipodetalle]:checked').val() == 1 ? $('input#preciocompra').val() : "0.00");
                ...
                Carrito.Ivaproducto = ($('input:radio[name=tipodetalle]:checked').val() == 1 ? $('input#ivaproducto').val() : "NO");
                Carrito.Existencia = ($('input:radio[name=tipodetalle]:checked').val() == 1 ? $('input#existencia').val() : "0");
                Carrito.Precioconiva = ($('input:radio[name=tipodetalle]:checked').val() == 1 && $('input#ivaproducto').val() == "SI" ? $('select#precioventa').val() : "0.00");
                ...
                var nuevaFila =
                    "<tr>" +
                        ...
                        "<input type='text' id='" + item.cantidad + "' class='bold' style='width:48px;height:34px;' value='" + item.cantidad + "'>" +
                        ...
                        "<td class='text-danger alert-link'>" + (item.tipodetalle == 1 ? 'PRODUCTO' : 'SERVICIO') + "</td>" +
...
function LimpiarTexto() {
    ...
    //$('#muestra_input').html("<option value=''>-- SIN RESULTADOS --</option>");
                ...
                TotalFactura   = parseFloat(Total.toFixed(2)) - parseFloat(TotalDescuentoGeneral.toFixed(2));
                   ...
                   var nuevaFila =
                    "<tr>" +
                        ...
                        "<td class='text-left'><h5><strong>" + item.producto + "</strong></h5><small>MARCA (" + (item.marcas == '' || item.marcas == '0' ? '******' : item.marcas) + ") - MODELO (" + (item.modelos == '' ? '****' : item.modelos) + ")</small></td>" +
                        "<td><strong>" + PrecioVenta.toFixed(2) + "</strong></td>" +
                        "<td><strong>" + ValorTotal.toFixed(2) + "</td>" +
                        "<td><strong>" + Descuento.toFixed(2) + "<sup>" + item.descproducto + "%</sup></strong></td>" +
                        "<td><strong>" + item.ivaproducto + "</strong></td>" +
                        "<td><strong>" + Operacion.toFixed(2) + "</strong></td>" +
                        "<td>" +
