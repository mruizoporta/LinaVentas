...
document.title = '.:: Sistema para la Gestión de Ventas ::.';		
$(".current-year").text('2019 - ' + new Date().getFullYear() + ' CopyRight. Todos los Derechos Reservados.');
...
cadenareloj = "" + day + "-" + num[mes]  + "-" + year + "     " + horas + ":" + minutos + ":" + segundos;
