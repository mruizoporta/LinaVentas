...
$(document).ready(function() {
    ...
    function AgregaPedidos () {        
        ...
        cantp = parseInt(cantp);
            ...
            "<td><h5><strong>" + item.producto + "</strong></h5></td>" +
            "<td><strong>" + (item.codmarca == '' || item.codmarca == '0' ? '******' : item.marcas) + "</strong></td>" +
            "<td><strong>" + (item.codmodelo == '' || item.codmodelo == '0' ? '****' : item.modelo) + "</strong></td>" +
            "<td>" +
...
function addItem(codigo, cantidad, producto, marcas, codmarca, modelo, codmodelo, opCantidad) {
    ...
    function(data, textStatus) {
        ...
        "<td><h5><strong>" + item.producto + "</strong></h5></td>" +
        "<td><strong>" + (item.codmarca == '' || item.codmarca == '0' ? '******' : item.marcas) + "</strong></td>" +
        "<td><strong>" + (item.modelo == '' || item.modelo == '0' ? '****' : item.modelo) + "</strong></td>" +
        "<td>" +
        '<button class="btn btn-rounded btn-dark" style="cursor:pointer;color:#fff;" ' +
        'onclick="addItem(' +
        "'" + item.txtCodigo + "'," +
