            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        for($i=0;$i<sizeof($color);$i++){ ?>
                        <option value="<?php echo $color[$i]['codcolor'] ?>"><?php echo $color[$i]['nomcolor'] ?></option><?php } } ?>
                        </select> 
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="precioxmenor" id="precioxmenor" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" placeholder="Ingrese Precio Venta x Menor" autocomplete="off" <?php if (isset($reg[0]['precioxmenor'])) { ?> value="<?php echo number_format($reg[0]['precioxmenor'], 2, '.', ''); ?>" <?php } ?>  required="" aria-required="true"/>  
                        <i class="fa fa-tint form-control-feedback"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control" name="precioxmayor" id="precioxmayor" onKeyUp="this.value=this.value.toUpperCase();" onKeyPress="EvaluateText('%f', this);" onBlur="this.value = NumberFormat(this.value, '2', '.', '')" placeholder="Ingrese Precio Venta x Mayor" autocomplete="off" <?php if (isset($reg[0]['precioxmayor'])) { ?> value="<?php echo number_format($reg[0]['precioxmayor'], 2, '.', ''); ?>" <?php } ?>  required="" aria-required="true"/>  
                        <i class="fa fa-tint form-control-feedback"></i>
                    </div>
                </div>
        ...
        <?php } else {  ?> 
                ...
                <div class="col-md-3"> 
                    <div class="form-group has-feedback"> 
                      ...
                      <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="sucursal" id="sucursal" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $_SESSION["nomsucursal"]; ?>" readonly="readonly">
