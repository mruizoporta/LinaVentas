...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <form class="form form-material" method="post" action="#" name="buscakardex" id="buscakardex">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                       <div class="form-group has-feedback">
                           ...
                           <input type="text" class="form-control" name="search_kardex_producto" id="search_kardex_producto" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Descripción del Producto para tu Búsqueda" autocomplete="off" required="" aria-required="true"/>  
...
<?php } ?>
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscaKardexProductos()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
