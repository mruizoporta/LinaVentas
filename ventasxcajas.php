...
<div class="row">
               ...
               <div class="form-group has-feedback">
                ...
                <select style="color:#000;font-weight:bold;" name="codcaja" id="codcaja" class='form-control' required="" aria-required="true">
                    ...
                    for($i=0;$i<sizeof($caja);$i++){
                      ?>
                      <option style="color:#000;font-weight:bold;" value="<?php echo encrypt($caja[$i]['codcaja']) ?>"><?php echo $caja[$i]['nrocaja'].": ".$caja[$i]['nomcaja']." - ".$caja[$i]['nombres']; ?></option>         
                  <?php } ?>
              </select>
            </div>
        </div> 
    ...
    <?php } ?> 
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscarVentasxCajas()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
