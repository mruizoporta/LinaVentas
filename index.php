...
<body>
    <div class="main-wrapper bg-login">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <!--div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(assets/images/login-register.jpg) no-repeat center top; position: absolute; height: 100%; width: 100%; top: 0; left: 2px;"-->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center login-blespost">
            
            <div class="logo">
              <?php if (file_exists("assets/images/logo_blespost_white.png")){
                echo "<img src='assets/images/logo_blespost_white.png' alt='BlesPost'>"; 
                        } else {
                echo "<img src='' alt='BlesPost'>"; 
                        } 
                ?>
            </div>
            <div class="auth-box">
                  ...
                  <div class="col-12">
                   ...
                   <form class="form form-material new-lg-form" name="formlogin" id="formlogin" action="">
                    ...
                    <div class="form-group text-center m-t-20">
                      <div class="col-xs-12">
                        <button class="btn btn-secondary btn-login btn-lg btn-block waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Haga clic aquí para iniciar sesión" name="btn-login" id="btn-login" type="submit"><span class="fa fa-sign-in"></span> Acceder</button>
                      </div>
                    </div>

                    <div class="form-group">
                      <div class="col-md-12">
                        <a href="javascript:void(0)" id="to-recover" class="text-white"><i class="fa fa-lock"></i> Olvidaste tu Contraseña?</a>          
                      </div>
                    </div>
            ...
            <div id="recoverform">
                ...
                <form class="form form-material new-lg-form" name="formrecover" id="formrecover" action="">
                  ...
                  <div class="row">
                    <div class="col-md-12 m-t-20">    
                      <p class="text-white">Ingrese su correo electrónico para que su Nueva Clave de Acceso le sea enviada al mismo!</p>
                      <hr>
                      <div class="form-group has-feedback">
                 ...
                 <div class="form-group text-center m-t-20">
                  <div class="col-xs-12">
                    <button class="btn btn-secondary btn-login btn-lg btn-block waves-effect waves-light" name="btn-recuperar" id="btn-recuperar" type="submit"><span class="fa fa-check-square-o"></span> Recuperar Password</button>
                  </div>
                </div>
                
                <div class="form-group">
                  <div class="col-md-12">
                    <a href="javascript:void(0)" id="to-login" class="text-white"><i class="fa fa-arrow-circle-left"></i> Acceder al Sistema</a>
                  </div>
                </div>
