...
<div id="ModalAbonosProveedor" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form form-material" name="saveabonosproveedor" id="saveabonosproveedor" action="#">
...
<!-- /.modal --> 
    ...
    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Créditos por Proveedor</h5>
                    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Créditos por Proveedor</h4>
            </div>
            
        <form class="form form-material" method="post" action="#" name="creditosxproveedor" id="creditosxproveedor">
    ...
    <?php } ?> 
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscarCreditosxProveedor()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestracreditosxproveedor"></div>
