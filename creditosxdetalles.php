...
<div id="ModalAbonos" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <form class="form form-material" method="post" action="#" name="saveabonosdetalles" id="saveabonosdetalles">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Créditos por Detalles</h4>
            </div>
