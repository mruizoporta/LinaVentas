...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form class="form form-material" name="procesarcotizacion" id="procesarcotizacion" action="#">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group has-feedback">
                            ...
                            <input style="color:#000;font-weight:bold;" type="text" class="form-control" name="busqueda" id="busqueda" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Criterio para Búsqueda de Cliente" autocomplete="off" required="" aria-required="true"/> 
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="form-body">
                ...
                <form class="form form-horizontal" method="post" action="#" name="busquedacotizaciones" id="busquedacotizaciones">

                <div class="row">
                    <div class="col-md-12">
                        <label class="control-label">Búsqueda de Cotización: <span style="cursor: pointer;" class="mdi mdi-alert-circle text-danger" data-container="body" title="Notificación: Ingrese Criterio de Búsqueda por Nº de Factura, Nº Documento de Cliente, Nombres de Cliente, Nº de Sucursal, Nombre de Sucursal."></span></label>
                        <div class="input-group mb-3">
                            <div class="input-group-append">
                            <button type="button" onClick="BuscarCotizaciones();" class="btn btn-success waves-effect waves-light" data-placement="left" title="Buscar Cotizaciones"><i class="fa fa-search-plus"></i></button>
                            </div>
                            <input type="text" class="form-control" name="bcotizaciones" id="bcotizaciones" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Criterio para tu Búsqueda" autocomplete="off" autocomplete="off" required="" aria-required="true"> 
                        </div>
                    </div>
                </div>
                ...
                <div id="muestracotizaciones"></div>
...
<!-- End Row -->
    ...
    $('#bcotizaciones').keypress(function(e) {
