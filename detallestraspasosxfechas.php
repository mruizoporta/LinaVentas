...
<div class="row">
    ...
    <form class="form form-material" method="post" action="#" name="detallestraspasosxfechas" id="detallestraspasosxfechas">
    ...
    <?php } ?> 
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscaDetallesTraspasosxFechas()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestradetallestraspasosxfechas"></div>
