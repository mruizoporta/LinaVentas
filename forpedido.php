...
for($i=0;$i<sizeof($detalle);$i++){  
    ?>
      ...
      <td><strong><input type="hidden" name="coddetallepedido[]" id="coddetallepedido" value="<?php echo $detalle[$i]["coddetallepedido"]; ?>"><?php echo $detalle[$i]['codproducto']; ?></strong></td>
      <td><strong><?php echo $detalle[$i]['producto']; ?></strong></td>
      <td><strong><?php echo $detalle[$i]['nommarca']; ?></strong></td>
      <td><strong><?php echo $detalle[$i]['nommodelo']; ?></strong></td>
...
for($i=0;$i<sizeof($detalle);$i++){  
    ?>
      ...
      <td><strong><?php echo $detalle[$i]['nommarca']; ?></strong></td>
      <td><strong><?php echo $detalle[$i]['nommodelo']; ?></strong></td>
      <td><strong><?php echo $detalle[$i]['cantpedido']; ?></strong></td>
 <?php if ($_SESSION['acceso'] == "administradorG" || $_SESSION["acceso"]=="administradorS") { ?><td>
...
<a href="pedidos"><button class="btn btn-dark" type="reset"><span class="fa fa-trash-o"></span> Cancelar</button></a> 
<?php } else if (isset($_GET['codpedido']) && isset($_GET['codsucursal']) && decrypt($_GET["proceso"])=="A") { ?>  
