...
<body onLoad="muestraReloj()" class="fix-header">
   ...
   <!-- ============================================================== -->
    ...
    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Traspasos por Sucursal</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item">Traspasos</li>
                                <li class="breadcrumb-item active" aria-current="page">Por Sucursal</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="traspasosxsucursal" id="traspasosxsucursal">
              ...
              <div class="form-group has-feedback"> 
                  ...
                  <?php } ?>
                    ...
                    <div class="text-right">
                        <button type="button" onClick="BuscarTraspasosxSucursal()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestratraspasosxsucursal"></div>
