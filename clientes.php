...
<!--############################## MODAL PARA VER CARGA MASIVA DE CLIENTES ######################################-->
<!-- sample modal content -->
<div id="myModalCargaMasiva" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="btn-cliente" id="btn-cliente" class="btn btn-danger"><span class="fa fa-cloud-upload"></span> Cargar</button>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="form-body">
                ...
                <form class="form form-horizontal" method="post" action="#" name="busquedaclientes" id="busquedaclientes">

                <div class="row">
                    <div class="col-md-12">
                        <label class="control-label">Búsqueda de Cliente: <span style="cursor: pointer;" class="mdi mdi-alert-circle text-danger" data-container="body" title="Notificación: Ingrese Criterio de Búsqueda por Nº de Documento, Nombres, Razón Social, Dirección Domiciliaria, Correo Electronico."></span></label>
                        <div class="input-group mb-3">
                            <div class="input-group-append">
                            <button type="button" onClick="BuscarClientes();" class="btn btn-success waves-effect waves-light" data-placement="left" title="Buscar Cliente"><i class="fa fa-search-plus"></i></button>
                            </div>
                            <input type="text" class="form-control" name="bclientes" id="bclientes" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Criterio para tu Búsqueda" autocomplete="off" autocomplete="off" required="" aria-required="true"> 
                        </div>
                    </div>
                </div>
